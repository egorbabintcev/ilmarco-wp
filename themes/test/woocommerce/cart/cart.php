...
<!--                </thead>-->
				...
				foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
					...
					if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
						...
						?>
                        <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?> cart-item">
...
//		                            ?>
                                    ...
                                    <p class="cart-item__params">
                                        Размер <?php the_field( 'pizza_diameter', $_product->id ); ?> |
                                        Вес <?php the_field( 'pizza_weight', $_product->id ); ?></p>
                                </div>
                            </td>
...
<!--                            </td>-->
                            ...
                            <td class="product-quantity col" data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>">
								<?php
