            ...
            <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
				...
				foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
					...
					if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
						...
						?>
                        <tr class="woocommerce-cart-form__cart-item cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">

                            <td class="product-thumbnail col">
                                ...
                                <div>
                                    ...
                                    <p class="cart-item__params">
                                        Размер <?php the_field( 'pizza_diameter', $_product->id ); ?> см |
                                        Вес <?php the_field( 'pizza_weight', $_product->id ); ?> гр</p>
                                </div>
                            </td>
                            ...
                            <td class="product-subtotal col"
                                ...
                                <div class="cart-item__sum">
                                    ...
                                    <div class="cart-item__counter">
                                        <!--                                        <a class="cart-item__counter-btn dec">-->
                                        <!--                                            <svg>-->
                                        <!--                                                <use xlink:href="-->
                                        ...
                                        <!--                                        <a class="cart-item__counter-btn inc">-->
                                        <!--                                            <svg>-->
                                        <!--                                                <use xlink:href="-->
								...
								<?php
								echo sprintf(
									'<a href="%s" class="cart-item__del remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><svg>
                    ...
                    <td colspan="3" class="actions">
						<?php if ( wc_coupons_enabled() ) { ?>
                            <div class="coupon">
                                ...
                                <input type="text" name="coupon_code" class="input-text cart-promocode__input"
