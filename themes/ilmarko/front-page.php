    ...
    <main>
        ...
        <section class="catalog" id="catalog">
            <div class="container">
                ...
                <div class="catalog-pages">
                    ...
                    <small>₽</small></span>
                                    ...
                                    <a href="?add-to-cart=<?= $product->get_id() ?>" data-quantity="1"
                                       ...
                                       data-product_id="<?= $product->get_id() ?>" data-product_sku=""
                                       aria-label="Добавить в корзину" rel="nofollow">В коробку
                ...
                <img class="bg-pic bg-pic_pizza-stroke"
                     src="<?= get_template_directory_uri(); ?>/assets/img/pic-pizza-stroke.png"/>
            </div>
        </section>
