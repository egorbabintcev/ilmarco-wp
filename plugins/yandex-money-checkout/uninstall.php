...
if ( ! defined( 'WP_UNINSTALL_PLUGIN' ) ) {
    ...
    delete_option('ym_api_add_installments_block');
    delete_option('ym_api_success');
    delete_option('ym_api_fail');
    delete_option('ym_api_tax_rates_enum');
    delete_option('ym_api_enable_hold');
    delete_option('ym_api_description_template');
    ...
    delete_option('ym_api_nps_vote_time');
}
